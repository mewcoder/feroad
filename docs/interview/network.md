...
- HTTP2.0 中，有两个⾮常重要的概念，分别是帧（frame）和流（stream）。帧代表着最小的数据单位，每个帧会标识出该帧属于哪个流，流也就是多个帧组成的数据流。
...
攻击者利用 HTTP 请求会携带 cookie 的特定，利用用户的登陆状态发送恶意请求。
...
一段 JWT 字符串包含三部分，分别是 header、payload 和 signature，头部、载荷和签名。
[https://juejin.cn/post/7129298214959710244#heading-26](https://juejin.cn/post/7129298214959710244#heading-26)
[https://juejin.cn/post/6898630134530752520](https://juejin.cn/post/6898630134530752520)
